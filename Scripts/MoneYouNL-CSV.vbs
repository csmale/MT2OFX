...
Const ScriptVersion = "$Header: /MT2OFX/MoneYouNL-CSV.vbs 1     25/02/09 21:06 Colin $"
...
With Params
	...
	.ScriptName = "MoneYouNL-CSV"
	.FormatName = "MoneYou (Nederland) CSV"
...
' to the text between the top-level parentheses.
	...
	.MonthNames = Empty
' Nr v/d rekening :;Boekdatum;Beschrijving;Bedrag v/d verrichting;Munt;Valutadatum;Rekening tegenpartij;
' Naam v/d tegenpartij :;Adres v/d tegenpartij :;Stad v/d tegenpartij :;Mededeling 1 :;Mededeling 2 :;
' Mededeling 3 :;Mededeling 4 :;Ref. v/d verrichting
	.Fields = Array( _
		Array(fldAccountNum, "Nr v/d rekening :"), _
		...
		Array(fldSkip, "Adres v/d tegenpartij :"), _
		Array(fldSkip, "Stad v/d tegenpartij :"), _
		Array(fldMemo, "Mededeling 1 :"), _
		Array(fldMemo, "Mededeling 2 :"), _
		Array(fldMemo, "Mededeling 3 :"), _
		Array(fldMemo, "Mededeling 4 :"), _
