' MT2OFX Input Processing Script De Post (BE) CSV format

Option Explicit

Const ScriptVersion = "$Header: /MT2OFX/DePostBE-CSV.vbs 2     16/12/06 1:06 Colin $"

Const ScriptName = "DePostBE-CSV"
Const FormatName = "De Post (BE) CSV Formaat"
...
Const MinFieldsExpected = 11
Const MaxFieldsExpected = 11
...
' "Verrichtingsnummer";"Verrichtingsdatum";"Omschrijving";"Bedrag van de beweg.";"Valuta";"Valuta datum";
' "Rekening tegenpartij";"Naam tegenpartij";"Mededeling";"Mededeling (vervolg)";"Verrichtingsreferentie"
Dim aFields
aFields = Array( _
...
' keep tabs on the statement/balance Date
			...
			If NoAvailableBalance Then Stmt.AvailableBalance.Ccy = ""
		End If
	Loop
	LoadTextFile = True
End Function
