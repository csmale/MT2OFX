' MT2OFX Processing Script for Basler Kantonalbank (KBBECH22)

Option Explicit

Private Const ScriptVersion = "$Header: /MT2OFX/BaslerKantonalbank.vbs 1     25/11/08 23:55 Colin $"
Private Const FormatName = "Basler Kantonalbank MT940 format"
