' MT2OFX Input Processing Script CAIXA GERAL DE DEPOSITOS-SUCURSAL EN ESPANA TSV format
' NB: This Script Will Not Work Without Customisation!

Option Explicit

Const ScriptVersion = "$Header: /MT2OFX/CaixaGeralES-TSV.vbs 1     20/06/09 14:32 Colin $"
...
With Params
	...
	.ScriptName = "CaixaGeralES-TSV"
	.FormatName = "Caixa Geral de Depositos-Secursal TSV"
...
'F. Operación	F. Valor	Concepto	Importe	Saldo
	.Fields = Array( _
		Array(fldBookDate, "F. Operación"), _
		Array(fldValueDate, "F. Valor"), _
...
'MsgBox "In transaction callback: " & t.Memo
	t.ValueDate = ClosestEx(t.ValueDate, t.BookDate)
