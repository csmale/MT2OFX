...
Const ScriptVersion = "$Header: /MT2OFX/FinanceWorks-CSV.vbs 1     30/10/10 13:24 Colin $"
...
With Params
	...
	.ScriptName = "FinanceWorks-CSV"
	.FormatName = "Intuit FinanceWorks CSV"
...
' to the text between the top-level parentheses.
	...
	.MonthNames = Empty
' Date, Account Name, Check #, Transaction, Category, Note, Expense, Deposit
	.Fields = Array( _
		Array(fldBookDate, "Date"), _
		Array(fldAccountNum, "Account Name"), _
		Array(fldCheckNum, "Check #"), _
		Array(fldMemo, "Transaction"), _
		Array(fldCategory, "Category"), _
		Array(fldMemo, "Note"), _
		Array(fldAmtDebit, "Expense"), _
