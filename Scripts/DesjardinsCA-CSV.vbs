...
Const ScriptVersion = "$Header: /MT2OFX/DesjardinsCA-CSV.vbs 2     3/04/06 9:28 Colin $"

Const ScriptName = "DesjardinsCA-CSV"
Const FormatName = "Caisse Populaire Desjardins (Canada) CSV format"
...
Const MinFieldsExpected = 14
Const MaxFieldsExpected = 14
...
Const PayeeLocation = 37		' start of payee in memo
Const PayeeLength = 999		' length of payee in memo
...
'The 1st field is my bank branch
'The 2nd field (123456) would be my acc. number
'3rd: acc. type
'4th: date (YYYY/MM/DD)
'5th: transaction number into the file
'6th: Type of transaction             /(3rd party)
'7th: # of cheque (if applicable)
'8th: Withdraw amount (I/A)
'9th: Deposit amount (I/A)
'10,11,12,13th: Empty for Me
'14th: Amount in your account
...
' "Saint-Jerome","123456","EOP","2006/02/06",00001,"Achat                              /DEPANNEUR CHEZ LOU","",4.42,"","","","","",1010.68
Dim aFields
aFields = Array( _
	Array(fldSkip, "Branch Name"), _
	Array(fldAccountNum, "Account number"), _
	Array(fldSkip, "Account type"), _
	Array(fldBookDate, "Date"), _
	Array(fldSkip, "Sequence number"), _
	Array(fldMemo, "Txn type/payee"), _
	Array(fldChequeNum, "Cheque number"), _
	Array(fldAmtDebit, "Withdrawal amount"), _
	Array(fldAmtCredit, "Deposit amount"), _
	Array(fldEmpty, "Empty 1"), _
	Array(fldEmpty, "Empty 2"), _
	Array(fldEmpty, "Empty 3"), _
	Array(fldEmpty, "Empty 4"), _
...
Dim aPropertyList
aPropertyList = Array()	' no parameters for this script (yet)
