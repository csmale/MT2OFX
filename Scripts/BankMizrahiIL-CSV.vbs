' MT2OFX Input Processing Script Bank Mizrahi (Israel) CSV format

Option Explicit

Const ScriptVersion = "$Header: /MT2OFX/BankMizrahiIL-CSV.vbs 2     4/11/10 13:33 Colin $"
...
With Params
	...
	.ScriptName = "BankMizrahiIL-CSV"
	.FormatName = "Bank Mizrahi CSV"
   .Codepage = 1255
	...
	.CurrencyCode = "ILS"	' default if not specified in file
...
' to the text between the top-level parentheses.
	...
	.MonthNames = Empty
' NB: The input files are in Windows Code Page 1255
' 1/11/2009,"<hebrew text>",38.72,5071.49,77777777
' The fields, from left to right, are
' David Raines additions
' 1.       Date m/d/yyyy
' 2.       Memo - Payee (Hebrew characters between inverted commas)
' 3.       Credit
' 4.       Debit
' 5.       Balance
' 6.       Check number
    ...
    .Fields = Array( _
        Array(fldBookDate, "Transaction date"), _
