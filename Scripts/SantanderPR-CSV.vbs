' MT2OFX Input Processing Script Banco Santander (Puerto Rico) CSV format

Option Explicit

Const ScriptVersion = "$Header: /MT2OFX/SantanderPR-CSV.vbs 1     2/09/10 20:49 Colin $"
...
With Params
	...
	.ScriptName = "SantanderPR-CSV"
	.FormatName = "Banco Santander (Puerto Rico) CSV"
...
' to the text between the top-level parentheses.
	...
	.MonthNames = Empty
' Fecha,Descripción,Cheque,Débito,Crédito,Balance
	.Fields = Array( _
		Array(fldBookDate, "Fecha"), _
		Array(fldMemo, "Descripción"), _
		Array(fldCheckNum, "Cheque"), _
