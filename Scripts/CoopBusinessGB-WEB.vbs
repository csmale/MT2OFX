...
With Params
	...
	.ScriptName = "CoopBusinessGB-WEB"
	.FormatName = "Cooperative Bank (UK) Web"
...
' to the text between the top-level parentheses.
	...
	.TxnLinePattern = "(\d\d ... \d\d) (.{48}) ([0-9,]{11}\.\d\d) ([0-9,]{11}\.\d\d) ([0-9,]{11}\.\d\d)"
...
Function RecogniseTextFile()
    ...
    Do While Not AtEof()
        ...
        iLine = iLine + 1
'msgbox sLine
        If sLine = "    DATE     DESCRIPTION                                  WITHDRAWALS      DEPOSITS        BALANCE                                   " Then
    msgbox "got it"
            Params.SkipHeaderLines = iLine
