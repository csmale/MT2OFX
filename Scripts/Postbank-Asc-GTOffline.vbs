' MT2OFX Input Processing Script for Postbank NL Asc (Girotel Offline) format

Option Explicit

Private Const ScriptVersion = "$Header: /MT2OFX/Postbank-Asc-GTOffline.vbs 2     4/04/04 21:42 Colin $"

Const ScriptName = "Postbank-Asc"
Const FormatName = "Postbank (NL) Asc (Girotel Offline)Formaat"
...
Const fldBedrag = 8
'	9	261-263	3	valuta (EUR)
Const fldValuta = 9
'	10	99-100	2	Af/Bij + "M" ?
Const fldAfBij = 10
'	11	101-132	32	omschrijving 3
Const fldOmschrijving1 = 10
'	12	133-164	32	omschrijving 4
Const fldOmschrijving2 = 11
'	13	165-196	32	omschrijving 5
Const fldOmschrijving3 = 12
'	14	197-228	32	omschrijving 6
Const fldOmschrijving4 = 13
'	15	229-260	32	omschrijving 7
