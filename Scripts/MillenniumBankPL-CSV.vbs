' MT2OFX Input Processing Script Millennium Bank (PL) CSV format

Option Explicit

Const ScriptVersion = "$Header: /MT2OFX/MillenniumBankPL-CSV.vbs 3     30/08/09 13:35 Colin $"
...
With Params
	...
	.ScriptName = "MillenniumBankPL-CSV"
	.FormatName = "Millennium Bank (Poland) CSV"
...
' to the text between the top-level parentheses.
	...
	.MonthNames = Empty
'The header:
'Numer rachunku/karty,Data transakcji,Data rozliczenia,Rodzaj transakcji,Na rachunek/ Z rachunku,Odbiorca/Zleceniodawca,Opis,Obciążenie,Uznanie,Saldo,Waluta
'Means:
'Account Number / Card Number, Transaction Date, Settlement Date, Transaction Type, To/From Account, Payee, Description, Withdrawal, Deposit, Balance, Currency
	.Fields = Array( _
		Array(fldAccountNum, "Numer rachunku/karty"), _
		Array(fldTransactionDate, "Data transakcji"), _
		Array(fldBookDate, "Data rozliczenia"), _
		Array(fldSkip, "Rodzaj transakcji"), _
		Array(fldSkip, "Na rachunek/ Z rachunku"), _
		Array(fldPayee, "Odbiorca/Zleceniodawca"), _
		Array(fldMemo, "Opis"), _
		Array(fldAmtDebit, "Obciążenie"), _
		Array(fldAmtCredit, "Uznanie"), _
		Array(fldClosingBal, "Saldo"), _
		Array(fldCurrency, "Waluta") _
	)
...
Function RecogniseTextFile()
    Session.InputFile.Codepage = 1250  ' for Polish
