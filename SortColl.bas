Attribute VB_Name = "SortColl"
Option Explicit

' $Header: /MT2OFX/SortColl.bas 2     4/04/04 21:24 Colin $

Public Sub SortCollection(col As Collection, psSortPropertyName As String, _
    pbAscending As Boolean, Optional psKeyPropertyName As String)
